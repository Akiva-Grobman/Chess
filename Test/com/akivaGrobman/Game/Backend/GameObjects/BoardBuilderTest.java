...
class BoardBuilderTest {
    ...
    void initializationOfNewBoardReturnsCorrectBoard() throws Exception{
        Tile[][] board;
        String expectedBoard =  "[[|  ROOK  |, | KNIGHT |, | BISHOP |, |  KING  |, |  QUEEN |, | BISHOP |, | KNIGHT |, |  ROOK  |], [|  PAWN  |, |  PAWN  |, |  PAWN  |, |  PAWN  |, |  PAWN  |, |  PAWN  |, |  PAWN  |, |  PAWN  |], [|        |, |        |, |        |, |        |, |        |, |        |, |        |, |        |], [|        |, |        |, |        |, |        |, |        |, |        |, |        |, |        |], [|        |, |        |, |        |, |        |, |        |, |        |, |        |, |        |], [|        |, |        |, |        |, |        |, |        |, |        |, |        |, |        |], [|  PAWN  |, |  PAWN  |, |  PAWN  |, |  PAWN  |, |  PAWN  |, |  PAWN  |, |  PAWN  |, |  PAWN  |], [|  ROOK  |, | KNIGHT |, | BISHOP |, |  KING  |, |  QUEEN |, | BISHOP |, | KNIGHT |, |  ROOK  |]]";
    ...
    void initializationOfCostumeBoardReturnsCorrectBoard() throws Exception {
        Tile[][] board;
        String expectedBoard = "[[|  ROOK  |, | KNIGHT |, | BISHOP |, |  KING  |, |  QUEEN |, |        |, | KNIGHT |, |  ROOK  |], [|  PAWN  |, |  PAWN  |, |  PAWN  |, |  PAWN  |, |  PAWN  |, |  PAWN  |, |  PAWN  |, |  PAWN  |], [|        |, |        |, |        |, |        |, |        |, |        |, |        |, |        |], [|        |, |        |, |        |, |  KING  |, |        |, |        |, |        |, |        |], [|        |, |        |, |        |, |        |, |  PAWN  |, |        |, |        |, |        |], [|        |, |        |, |        |, |        |, |        |, |        |, |        |, |        |], [|  PAWN  |, |  PAWN  |, |        |, |  PAWN  |, |  PAWN  |, |  PAWN  |, |  PAWN  |, |  PAWN  |], [|  ROOK  |, | KNIGHT |, | BISHOP |, |  KING  |, |  QUEEN |, | BISHOP |, | KNIGHT |, |  ROOK  |]]";
